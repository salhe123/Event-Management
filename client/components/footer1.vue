...
<template>
  <footer class="bg-gradient-to-r from-gray-900 via-gray-700 to-gray-900 py-8 sm:py-14 px-6 sm:px-16 font-sans tracking-wide">
    <div class="text-center sm:text-left grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
      <div>
        <h2 class="text-white text-lg font-semibold mb-4">Quick Links</h2>
        <ul class="space-y-2">
          <li><a href="#" class="text-gray-300 hover:text-white text-sm transition-all">Newsroom</a></li>
          <li><a href="#" class="text-gray-300 hover:text-white text-sm transition-all">Tailwind CSS</a></li>
          <li><a href="#" class="text-gray-300 hover:text-white text-sm transition-all">Careers</a></li>
        </ul>
      </div>
      ...
      <div>
        ...
        <ul class="space-y-2">
          <li><a href="#" class="text-gray-300 hover:text-white text-sm transition-all">Github</a></li>
          <li><a href="#" class="text-gray-300 hover:text-white text-sm transition-all">LinkedIn</a></li>
          <li><a href="#" class="text-gray-300 hover:text-white text-sm transition-all">Twitter</a></li>
        </ul>
      </div>
      ...
      <div>
        ...
        <ul class="space-y-2">
          <li><a href="#" class="text-gray-300 hover:text-white text-sm transition-all">About</a></li>
          <li><a href="#" class="text-gray-300 hover:text-white text-sm transition-all">Privacy Policy</a></li>
          <li><a href="#" class="text-gray-300 hover:text-white text-sm transition-all">Terms & Conditions</a></li>
        </ul>
      </div>
    </div>
    ...
    <div class="flex flex-col sm:flex-row sm:justify-between items-center gap-6">
      <div class="flex space-x-5">
        ...
        <a href="#" class="text-gray-300 hover:text-white transition-all">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" class="fill-gray-400 hover:fill-white w-5 h-5" viewBox="0 0 24 24">
      ...
      <p class="text-gray-300 text-sm mt-4 sm:mt-0">All rights reserved.</p>
    </div>
  </footer>
</template>

<style scoped>
/* Add any additional custom styles as necessary */
</style>
