          ...
          <form @submit.prevent="handleSubmit(handleLogin)">
            <div class="mb-12">
              ...
              <p class="text-sm mt-4 text-gray-800">
                Don't have an account? <nuxt-link to="/auth/signup" class="text-blue-600 font-semibold hover:underline ml-1 whitespace-nowrap">Register here</nuxt-link>
              </p>
            </div>
            ...
            <div>
              ...
              <div class="relative flex items-center">
                <input v-model="email" type="text" required class="w-full text-gray-800 text-sm border-b border-gray-300 focus:border-blue-600 px-2 py-3 outline-none" placeholder="Enter email" />
            ...
            <div class="mt-8">
              ...
              <div class="relative flex items-center">
                <input v-model="password" type="password" required class="w-full text-gray-800 text-sm border-b border-gray-300 focus:border-blue-600 px-2 py-3 outline-none" placeholder="Enter password" />
