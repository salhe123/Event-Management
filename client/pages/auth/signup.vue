...
<template>
  <div class="flex justify-center items-center min-h-screen bg-gradient-to-br from-blue-300 via-indigo-200 to-purple-300 p-4">
    <div class="flex flex-col md:flex-row w-full max-w-4xl bg-gray-200 rounded-lg shadow-lg overflow-hidden">
        ...
        <form @submit.prevent="onSubmit" class="space-y-6">
          ...
          <div class="flex gap-4">
            <div class="relative w-1/2">
              <label for="first_name" class="block text-gray-600 text-sm font-bold mb-2">First Name</label>
              <Field
                name="first_name"
                type="text"
                placeholder="First name"
                class="w-full p-1 pl-10 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 bg-gray-100 text-gray-800"
              />
            ...
            <div class="relative w-1/2">
              <label for="last_name" class="block text-gray-600 text-sm font-bold mb-2">Last Name</label>
              <Field
                name="last_name"
                type="text"
          ...
          <div class="relative">
            ...
            <Field
              ...
              class="w-full p-1 pl-10 border border-gray-700 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 bg-gray-800 text-white"
            />
          ...
          <div class="relative">
            <label for="confirmPassword" class="block text-gray-600 text-sm font-bold mb-2">Confirm Password</label>
            <Field
              name="confirmPassword"
              :type="showConfirmPassword ? 'text' : 'password'"
              placeholder="Confirm your password"
              class="w-full p-3 pl-10 border border-gray-700 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 bg-gray-800 text-white"
            />
            <button
              type="button"
          ...
          >
            ...
            <nuxt-link to="/auth/login" class="text-blue-600 hover:text-blue-800 font-medium">
      ...
      <!-- Image Section -->
      <div class="w-full md:w-1/2 hidden md:flex items-center justify-center bg-gray-200">
        <img
