...
<template>
  <div class="flex justify-center items-center min-h-screen bg-gray-100 mt-20 px-4 sm:px-6 lg:px-8">
    <div class="bg-white p-8 rounded-lg shadow-lg w-full max-w-md sm:max-w-lg">
      ...
      <form @submit.prevent="handleSubmit" class="space-y-6">
        ...
        <p v-if="uploading" class="self-center text-center w-full">Uploading image....</p>
        <button 
          v-else
          type="submit"
